/*
88888       88888   .oooooo.  888b      888   .o8    888   888
888888     888888  d88'  `88b 88888b    888 .o88800  888   888
888 888   888 888  888    888 888 88b   888   888     888  888
888  888 888  888  888    888 888  88b  888   888      888o888
888   88888   888  888    888 888   88b 888   888          888
888    888    888  d88'  `88b 888    88b888   888   o      888
888           888   .oooooo.  888     88888   "8888"     888b
...
if (!process.env.FORK) {
    winston.info('88888       88888   .oooooo.  888b      888   .o8    888   888');
    winston.info('888888     888888  d88`  `88b 88888b    888 .o88800  888   888');
    winston.info('888 888   888 888  888    888 888 88b   888   888     888  888');
    winston.info('888  888 888  888  888    888 888  88b  888   888      888o888');
    winston.info('888   88888   888  888    888 888   88b 888   888          888');
    winston.info('888    888    888  d88`  `88b 888    88b888   888   o      888');
    winston.info('888           888   .oooooo.  888     88888   "8888"     888b');
    winston.info('==========================================================================');
    winston.info('HelpDesk v' + pkg.version + ' Copyright (C) 2018-2019 Monty Chawda');
    winston.info('');
